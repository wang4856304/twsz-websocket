...
public class TwszWebSocketHandler implements WebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession webSocketSession) throws Exception {
        ...
        if (!StringUtils.isEmpty(userId)) {
            ...
            webSocketSession.sendMessage(new TextMessage("当前服务器ip为:" + NetUtil.getLocalHostLANAddress()));
        }
    ...
    public void handleMessage(WebSocketSession webSocketSession, WebSocketMessage<?> webSocketMessage) throws Exception {
        ...
        String destUserId = jsonObject.getString("destUserId");
        sendMessageToUser(destUserId, new TextMessage(message));
    }
